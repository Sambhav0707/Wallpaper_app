...
class CategoryScreenSunsets extends StatefulWidget {
  String sunsets;
   CategoryScreenSunsets({super.key,required this.sunsets});

  @override
  State<CategoryScreenSunsets> createState() => _CategoryScreenSunsetsState();
}

class _CategoryScreenSunsetsState extends State<CategoryScreenSunsets> {
  final ApiOperations apiOperations = ApiOperations();
  final ShimmerWidget shimmerWidget = ShimmerWidget();

  List<PhotosModel> categoryResultsSunsets=[];
  GetCategoryResultsForSunsets()async{
    categoryResultsSunsets=await ApiOperations.selectedCategory(widget.sunsets);
    setState(() {
  ...
  void initState() {
    ...
    super.initState();
    GetCategoryResultsForSunsets();
  }
  Future<void>GetCatLoadMoreSunsets() async {
    await apiOperations.loadCategoryResultsMore(widget.sunsets);
            ...
            child: CustomScrollView(
              ...
              slivers: <Widget>[
                ...
                SliverPadding(
                  ...
                  sliver: categoryResultsSunsets.isEmpty ? shimmerWidget.GetShimmerLoading() : SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount: categoryResultsSunsets.length,
                    ),
                  ),
                ),
